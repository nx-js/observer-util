...
for (let key in priorities) {
  ...
  describe(`observe with ${key} priority`, () => {
    it('should throw TypeError on invalid first argument', () => {
      expect(() => observe(12), priority).to.throw(TypeError)
      expect(() => observe({}, priority)).to.throw(TypeError)
      expect(() => observe(), priority).to.throw(TypeError)
    })
    ...
    it('should handle multiple reactions', async () => {
      let dummy1, dummy2
      const counter = observable({ num: 0 })
      const reaction1 = observe(() => (dummy1 = counter.num), priority)
      const reaction2 = observe(() => (dummy2 = counter.num), priority)
    ...
    it('should observe nested properties', async () => {
      ...
      const reaction = observe(() => (dummy = counter.nested.num), priority)
    ...
    it('should observe delete operations', async () => {
      ...
      const reaction = observe(() => (dummy = obj.prop), priority)
    ...
    it('should observe function call chains', async () => {
      let dummy
      const counter = observable({ num: 0 })
      const reaction = observe(() => (dummy = getNum()), priority)
    ...
    it('should observe iteration', async () => {
      ...
      const reaction = observe(() => (dummy = list.join(' ')), priority)
    ...
    it('should not observe symbol keyed properties', async () => {
      ...
      const reaction = observe(() => (dummy = obj[key]), priority)
    ...
    it('should not observe function valued properties', async () => {
      ...
      const reaction = observe(() => (dummy = obj.func), priority)
    ...
    it('should not observe set operations without a value change', async () => {
      ...
      const reaction = observe(propSpy, priority)
    ...
    it('should not observe $raw mutations', async () => {
      ...
      const reaction = observe(() => (dummy = obj.$raw.prop), priority)
    ...
    it('should rerun maximum once per stack', async () => {
      ...
      const reaction = observe(numsSpy, priority)
    ...
    it('should avoid infinite loops', async () => {
      ...
      const reaction1 = observe(spy1, priority)
      const reaction2 = observe(spy2, priority)
    ...
    it('should return the passed function', () => {
      const fn = () => {}
      const reaction = observe(fn, priority)
    ...
    it('should simply run the function once on multiple observation of the same function', async () => {
      ...
      const reaction1 = observe(counterSpy, priority)
      const reaction2 = observe(counterSpy, priority)
    ...
    it('should execute in first-tigger order', async () => {
      ...
      const reaction1 = observe(() => (dummy += obj.prop1), priority)
      const reaction2 = observe(() => (dummy += obj.prop2), priority)
      const reaction3 = observe(() => (dummy += obj.prop3), priority)
    ...
    it('should not be triggered by mutating a property, which is used in an inactive branch', async () => {
      ...
      const reaction = observe(conditionalSpy, priority)
